...
function gerarDocumento() {
    ...
    if (tipoProcesso === "filhosMenores" && tipoProcuracao === "pm") {
        textoProcura = `<strong>${nomeMaeMenor}</strong>, ${nacionalidadeMae}, no estado civil de ${estadoCivilMae}, ${profissaoMae}, com residência habitual em ${residenciaMae}, portadora do documento de identificação (${tipoDocumentoMae}) n.º ${documentoMae}, com data de expedição ${dataExpedicaoMae} pelo órgão emissor ${orgaoExpedidorMae}, e <br>
<strong>${nomePaiMenor}</strong>, ${nacionalidadePai}, no estado civil de ${estadoCivilPai}, ${profissaoPai}, com residência habitual em ${residenciaPai}, portadora do documento de identificação (${tipoDocumentoPai}) n.º ${documentoPai}, com data de expedição ${dataExpedicaoPai} pelo órgão emissor ${orgaoExpedidorPai}, constitui como sua bastante procuradora a <strong>Dra. CARLA OSSUNA</strong>, advogada inscrita na Ordem dos Advogados de Portugal, com cédula profissional sob o Nº 64201L, com morada profissional na Rua Febo Muniz, 27B, Edifício LACS Anjos - Código Postal 1150-152, Lisboa - Portugal, a quem confere os poderes especiais e necessários para os  representar perante a Conservatória dos Registos Centrais de Lisboa/Arquivo Distrital do Porto, ao abrigo do art. 1º, nº 1, al.c) da Lei da Nacionalidade nº 37/81, de 3 de Outubro, com sua posterior alteração pela Lei Orgânica n.º 2/2020, requerer a atribuição da Nacionalidade Portuguesa do nosso filh${generoLetra} ${nomeMenor}, nascid${generoLetra} em ${dataNascimentoMenor}, na cidade de ${cidadeNascimentoMenor}, no estado de ${estadoNascimento}, portador${genero === "homem" ? "" : "a"} do documento de identificação (${tipoDocumentoMenor}) n.° ${documentoMenor}, com expedição na data ${dataDocumentoMenor} pelo órgão ${orgaoExpedidorMenor},  e que seja lavrado o respetivo registo, por ser filh${generoLetra} de filh${generoLetra} de <strong> ${portugues} ${portugues === "pai" ? "português" : "portuguesa"}</strong>, promovendo, se necessário, a inscrição do respetivo nascimento, fixação do nome, praticando e assinando tudo o que seja necessário ao indicado fim, podendo, prestar declarações e substabelecer os poderes que lhe foram conferidos. `;
    }

    if (tipoProcesso === "filhosMenores" && tipoProcuracao === "m") {
        textoProcura = `<strong>${nomeMaeMenor}</strong>, ${nacionalidadeMae}, no estado civil de ${estadoCivilMae}, ${profissaoMae}, com residência habitual em ${residenciaMae}, portadora do documento de identificação (${tipoDocumentoMae}) n.º ${documentoMae}, com data de expedição ${dataExpedicaoMae} pelo órgão emissor ${orgaoExpedidorMae}, constitui como sua bastante procuradora a <strong>Dra. CARLA OSSUNA</strong>, advogada inscrita na Ordem dos Advogados de Portugal, com cédula profissional sob o Nº 64201L, com morada profissional na Rua Febo Muniz, 27B, Edifício LACS Anjos - Código Postal 1150-152, Lisboa - Portugal, a quem confere os poderes especiais e necessários para os  representar perante a Conservatória dos Registos Centrais de Lisboa/Arquivo Distrital do Porto, ao abrigo do art. 1º, nº 1, al.c) da Lei da Nacionalidade nº 37/81, de 3 de Outubro, com sua posterior alteração pela Lei Orgânica n.º 2/2020, requerer a atribuição da Nacionalidade Portuguesa do nosso filh${generoLetra} ${nomeMenor}, nascid${generoLetra} em ${dataNascimentoMenor}, na cidade de ${cidadeNascimentoMenor}, no estado de ${estadoNascimento}, portador${genero === "homem" ? "" : "a"} do documento de identificação (${tipoDocumentoMenor}) n.° ${documentoMenor}, com expedição na data ${dataDocumentoMenor} pelo órgão ${orgaoExpedidorMenor},  e que seja lavrado o respetivo registo, por ser filh${generoLetra} de filh${generoLetra} de<strong> ${portugues} ${portugues === "pai" ? "português" : "portuguesa"}</strong>, promovendo, se necessário, a inscrição do respetivo nascimento, fixação do nome, praticando e assinando tudo o que seja necessário ao indicado fim, podendo, prestar declarações e substabelecer os poderes que lhe foram conferidos. `
    }
